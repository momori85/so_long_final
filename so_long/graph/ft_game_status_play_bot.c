...
static void	ft_game_status_seed_zero(t_map *map, int seed)
{
	if (seed == 0)
	{
		if (map->bot->bot2_x != -1)
		...
		ft_map_seed_zero(map);
	}
}

static void	ft_game_status_seed_one(t_map *map, int seed)
{
	if (seed == 1)
	{
		if (map->bot->bot1_x != -1)
...
static void	ft_game_status_seed_two(t_map *map, int seed)
{
	if (seed == 2)
	{
		if (map->bot->bot2_x != -1)
...
static void	ft_game_status_seed_tree(t_map *map, int seed)
{
	if (seed == 3)
	{
		if (map->bot->bot1_x != -1)
